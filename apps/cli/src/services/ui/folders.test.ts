...
describe('removeFolder', () => {
  ...
  it('leaves a folder whose name merely starts the same', () => {
  ...
  it('will not delete the vault itself', () => {
    const gone = removeFolder(client, vault, '');
  ...
  it('says so when the folder is not there', () => {
    const gone = removeFolder(client, vault, 'never-existed');
