...
**memex** is one of three small, local-first tools that interoperate. They share one principle: **your data stays on your machine, and the AI comes to it** — no uploads, no cloud, no account.
