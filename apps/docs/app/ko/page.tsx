      ...
      <main className="page">
        ...
        <section className="hero">
          ...
          <p className="hero-sub">
            memex는 Claude에게 대화를 넘나드는 영구 메모리를 제공합니다, 인사이트를 자동으로
            저장하고, 필요할 때 의미적으로 찾아냅니다. 모든 데이터는 내 컴퓨터에만 저장됩니다.
            클라우드도, API 키도 필요 없습니다.
          </p>
            ...
            <div className="claude-body">
              ...
              >
                ...
                <div className="note-card" style={{ animation: 'card-in 0.3s ease 0.9s both' }}>
                  ...
                  <div className="note-snippet">
                    준호가 지적: 인증 모듈을 결제 로직과 분리할 것. DB 테이블을 공유하지 않는 별도의
                    바운디드 컨텍스트로 처리하기로 합의...
                  </div>
                </div>
                ...
                <div className="note-card" style={{ animation: 'card-in 0.3s ease 1.05s both' }}>
                  ...
                  <div className="note-snippet">
                    치명적 이슈 없음. /auth/token 엔드포인트에 레이트 리밋 추가 권고. 토큰 만료
                    15분이 보안 모범 사례 최솟값으로 지적됨...
                  </div>
                </div>
              </div>
              ...
              <div className="claude-ai-row" style={{ animation: 'card-in 0.3s ease 1.2s both' }}>
                ...
                <p className="claude-ai-text">
                  4월 14일 노트 기준으로: 세션 기반 인증 대신{' '}
                  <strong style={{ color: '#ededed' }}>JWT + 리프레시 토큰</strong>을 선택했습니다.
                  수평 확장 계획에 스테이트리스 토큰이 적합하다는 이유였습니다. 준호도 인증과 결제
                  로직 분리를 강조했고, 테이블을 공유하지 않는 별도 컨텍스트로 합의했습니다.
                </p>
              </div>
              ...
              <div className="claude-ai-row" style={{ animation: 'card-in 0.3s ease 2.05s both' }}>
                <div className="claude-avatar">C</div>
                <p className="claude-ai-text">
                  세컨드 브레인에 저장했습니다. 인증 마이그레이션 작업이나 Q3 로드맵 이야기가 나올
                  때 자동으로 꺼내드릴게요.
                </p>
              </div>
            </div>
          ...
          <div className="features">
            <div className="feature">
              ...
              <div>
                ...
                <div className="feature-desc">
                  모든 노트는 Markdown 파일로 vault에 저장되고 <code>~/.memex/memex.db</code>의 로컬
                  SQLite 데이터베이스에 인덱싱됩니다. 데이터는 절대 외부로 나가지 않습니다.
                  Obsidian과 즉시 호환됩니다.
                </div>
              </div>
            </div>
            <div className="feature">
              ...
              <div>
                ...
                <div className="feature-desc">
                  키워드가 아닌 의미로 노트를 찾습니다. 완전 오프라인으로 동작하는 다국어 임베딩
                  기반, API 키가 필요 없습니다. 한국어, 영어, 혼용 모두 자유롭게 검색 가능합니다.
                </div>
              </div>
            </div>
            <div className="feature">
              ...
              <div>
                ...
                <div className="feature-desc">
                  Claude Desktop과 Claude Code의 MCP 서버로 동작합니다. Claude가 답하기 전 자동으로
                  노트를 검색하고, 대화가 끝나면 인사이트를 능동적으로 저장합니다, 별도 설정 없이.
                </div>
              </div>
            </div>
            <div className="feature">
              ...
              <div>
                ...
                <div className="feature-desc">
                  ...
                  <code>--to</code>로 날짜 범위 필터링. 기존 Obsidian vault 등 외부 디렉터리를
                  인덱싱할 수 있습니다.
                </div>
              </div>
            </div>
            <div className="feature">
              ...
              <div>
                ...
                <div className="feature-desc">
                  <code>[[제목]]</code> 문법으로 노트를 연결합니다. <code>get_note</code>가 어떤
                  노트들이 이 노트를 참조하는지 자동으로 찾아줍니다, 수동 연결 없이도 사고의
                  그래프가 만들어집니다.
                </div>
              </div>
            </div>
            <div className="feature">
              ...
              <div>
                ...
                <div className="feature-desc">
                  <code>memex digest</code>로 최근 N일간 저장된 내용을 폴더별로 요약합니다. 이번 주
                  Claude가 무엇을 캡처했는지 빠르게 확인하는 방법입니다.
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="steps">
            ...
            <div className="step">
              ...
              <div>
                ...
                <div className="step-desc">
                  이제 Claude는 질문에 답하기 전 노트를 검색하고, 대화가 끝나면 중요한 컨텍스트를
                  자동으로 저장합니다, 따로 요청하지 않아도.
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="commands">
            ...
            <div className="command-row">
              ...
              <span className="cmd-desc">
                시맨틱 검색, <code>--from</code>, <code>--to</code>, <code>--tag</code> 지원
              </span>
            </div>
            <div className="command-row">
        ...
        <section className="section">
          ...
          <div className="privacy">
            <p>
              ...
              파일로, 임베딩은 로컬 SQLite 데이터베이스에. 임베딩 모델은
              <code
                style={{
                  fontFamily: 'var(--font-geist-mono)',
                  fontSize: '0.82em',
              ...
              를 사용해 완전 오프라인으로 동작합니다.
            </p>
            <p>
              텔레메트리, 계정, API 키가 필요 없습니다. 모델 다운로드 후 인터넷 연결 없이
              동작합니다.
            </p>
          </div>
          <a
