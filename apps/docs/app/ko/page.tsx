    ...
    <main className="page">
      ...
      <section className="hero">
        ...
        <p className="hero-sub">
          memex는 Claude에게 대화를 넘나드는 영구 메모리를 제공합니다, 인사이트를 자동으로 저장하고,
          필요할 때 의미적으로 찾아냅니다. 모든 데이터는 내 컴퓨터에만 저장됩니다. 클라우드도, API
          키도 필요 없습니다.
        </p>
          ...
          <div className="claude-body">
            ...
            <div className="claude-artifact" style={{ animation: 'card-in 0.35s ease 0.6s both' }}>
              ...
              <div className="note-card" style={{ animation: 'card-in 0.3s ease 1.05s both' }}>
                ...
                <div className="note-snippet">
                  치명적 이슈 없음. /auth/token 엔드포인트에 레이트 리밋 추가 권고. 토큰 만료 15분이
                  보안 모범 사례 최솟값으로 지적됨...
                </div>
              </div>
            </div>
            ...
            <div className="claude-ai-row" style={{ animation: 'card-in 0.3s ease 2.05s both' }}>
              <div className="claude-avatar">C</div>
              <p className="claude-ai-text">
                세컨드 브레인에 저장했습니다. 인증 마이그레이션 작업이나 Q3 로드맵 이야기가 나올 때
                자동으로 꺼내드릴게요.
              </p>
            </div>
          </div>
        ...
        <div className="features">
          <div className="feature">
            ...
            <div>
              ...
              <div className="feature-desc">
                ...
                SQLite 데이터베이스에 인덱싱됩니다. 데이터는 절대 외부로 나가지 않습니다. Obsidian과
                즉시 호환됩니다.
              </div>
            </div>
          </div>
          <div className="feature">
            ...
            <div>
              ...
              <div className="feature-desc">
                키워드가 아닌 의미로 노트를 찾습니다. 완전 오프라인으로 동작하는 다국어 임베딩 기반,
                API 키가 필요 없습니다. 한국어, 영어, 혼용 모두 자유롭게 검색 가능합니다.
              </div>
            </div>
          </div>
          <div className="feature">
          ...
          <div className="feature">
            ...
            <div>
              ...
              <div className="feature-desc">
                ...
                노트들이 이 노트를 참조하는지 자동으로 찾아줍니다, 수동 연결 없이도 사고의 그래프가
                만들어집니다.
              </div>
            </div>
          </div>
