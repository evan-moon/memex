...
const en = {
  ...
  note: {
    ...
    borrowed:
      'An agent can read this file but never write it. Edit it where it lives — memex would replace its front matter with its own.',
...
const ko: typeof en = {
  ...
  note: {
    ...
    readonly: 'AI는 읽기만',
    borrowed:
      'AI는 이 파일을 읽을 수만 있어요. 고치려면 원본 도구에서 — memex가 쓰면 이 파일의 frontmatter를 자기 형식으로 덮어써요.',
    hideSource: '원본 닫기',
