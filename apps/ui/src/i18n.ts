...
const en = {
  ...
  hypothesis: {
    ...
    redraft: 'Read them again',
    redrafting: 'Reading…',
    redraftHint: 'Claude reads the sources as they stand now — 1–2 minutes',
    proposed: 'What a second reading makes of them',
    save: 'Take this reading',
...
const ko: typeof en = {
  ...
  hypothesis: {
    ...
    redraft: '다시 읽히기',
    redrafting: '읽는 중…',
    redraftHint: 'Claude가 지금 상태의 근거를 다시 읽어 — 1~2분',
    proposed: '다시 읽으니 이렇게 나왔어',
    save: '이 읽기로 바꾸기',
