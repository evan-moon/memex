...
> ~~Superseded (2026-09-08): "`past` is immutable; a `past` note has no pencil at all."~~ Editing the text of a record and correcting the claim inside it are now separate operations. The first is a normal edit with history; the second is still a correction.
